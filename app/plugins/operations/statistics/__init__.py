...
class MeanOperation(Operation):
    ...
    def execute(self, *args, **kwargs):
        ...
        """
        self.logger.info("Executing mean operation with args: %s", args)
        ...
        try:
            ...
            self.logger.info("Mean calculation result: %s", result)
            return str(result)
...
class MedianOperation(Operation):
    ...
    def execute(self, *args, **kwargs):
        ...
        """
        self.logger.info("Executing median operation with args: %s", args)
        ...
        try:
            ...
            self.logger.info("Median calculation result: %s", result)
            return str(result)
        except Exception as e:
...
class StddevOperation(Operation):
    ...
    def execute(self, *args, **kwargs):
        ...
        """
        self.logger.info("Executing standard deviation operation with args: %s", args)
        ...
        try:
            ...
            self.logger.info("Standard deviation calculation result: %s", result)
            return str(result)
        except Exception as e:
